...
Privacy by default – No addresses, balances, amounts, or metadata ever exposed on-chain.
Infinite horizontal scalability – >1 million sustained TPS with no theoretical upper bound via dynamic neural sharding.
Post-quantum security from genesis – Full NIST-standard lattice-based cryptography (Dilithium-3, ML-KEM-768).
Endogenous intelligence – Nodes are rewarded for useful-work federated learning that perpetually improves the network's own encoders and predictors.
...
Whitepaper (v1.01 – 30 November 2025): NERV_Whitepaper_v1.01.pdf
Project Website / Landing Page: https://nerv-3w4y.vercel.app
Epics, User Stories & Technical Tasks: Epics_User stories and Technical tasks.pdf
Test Cases & Scripts: NERV Test cases and Test scripts.pdf
License: Dual MIT / Apache 2.0 – see LICENSE-MIT.txt and LICENSE-APACHE.txt

Current Repository Status
This monorepo is in early-stage development (as of December 2025):

Frontend landing page built with Next.js and Tailwind CSS (app/ directory).
...
Follow progress on the project website and future community channels (to be announced).

An FAQ document is in preparation and will be added soon.
The Future
Public testnet target: Q2 2026
Mainnet fair launch: June 2028
